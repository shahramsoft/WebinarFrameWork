...
namespace Service.Membership
{
    public sealed class FNHMembershipProvider : MembershipProvider
    {
        ...
        //private static IORMProvider<Users> _userRepository;
        ...
        private MembershipUser GetMembershipUserFromUser(Domain.Account.Users usr)
        {
            ...
            //    {
                    try
                    {
                        ...
                        if (usr != null)
                        {
                            ...
                            {
                                failureCount = usr.FailedPasswordAc;
                                windowStart = usr.FailedPasswordAws;
                            }

                            if (failureType == "passwordAnswer")
                            {
                                failureCount = usr.FailedPasswordAac;
                                windowStart = usr.FailedPasswordAaws;
                            }
                        }
                        ...
                        if (failureCount == 0 || DateTime.Now > windowEnd)
                        {
                            ...
                            if (failureType == "password")
                            {
                                if (usr != null)
                                {
                                    usr.FailedPasswordAc = 1;
                                    usr.FailedPasswordAws = DateTime.Now;
                                }
                            ...
                            if (failureType == "passwordAnswer")
                            {
                                if (usr != null)
                                {
                                    usr.FailedPasswordAac = 1;
                                    usr.FailedPasswordAaws = DateTime.Now;
                                }
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                if (failureType == "password")
                                    usr.FailedPasswordAc = failureCount;

                                if (failureType == "passwordAnswer")
                                    usr.FailedPasswordAac = failureCount;
        ...
        private MembershipUser GetMembershipUserByKeyOrUser(bool isKeySupplied, string username, object providerUserKey, bool userIsOnline)
        {
            ...
            //    {
                    ...
                    //{
                        ...
                        //                    .Add(NHibernate.Criterion.Restrictions.Eq("Id", (Guid)providerUserKey))
                        //                    .UniqueResult<Users>();
        ...
        private Users GetUserByUsername(string username)
        {
            ...
            //    {
                    ...
                    try
                    {
                        ...
                        //             .Add(NHibernate.Criterion.Restrictions.Eq("ApplicationName", ApplicationName))
                        //             .UniqueResult<Users>();
                        //var userprof = new Domain.Account.UsersContext();
                        using (UsersContext db = new UsersContext())
                        {
                          usr=  db.UserProfiles.FirstOrDefault(x => x.Username == username);
                        }
                         //usr = userprof.UserProfiles;
        ...
        {
            IList<Users> usrs=new List<Users>();
            var context = new Domain.Account.UsersContext();
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            //_userRepository = kernel.Get<IORMProvider<Users>>();
            //_userRepository.Initialize(_unitOfWork); 
                 ...
                 out MembershipCreateStatus status)
        {
            ...
            if (u == null)
            {
                ...
                //        user.PasswordAnswer = passwordAnswer != null ? EncodePassword(passwordAnswer) : null;
                ...
                //        user.FailedPasswordAc = 0;
                //        user.FailedPasswordAws = createDate;
                //        user.FailedPasswordAac = 0;
                //        user.FailedPasswordAaws = createDate;
        ...
        public override MembershipUserCollection FindUsersByName(string usernameToMatch, int pageIndex, int pageSize, out int totalRecords)
        {
            ...
            //        try
            //        {
            //            IList<Users> allusers = GetUsersLikeUsername(usernameToMatch);
            //            if (allusers == null)
            //                return users;
            //            if (allusers.Count > 0)
        ...
        public override MembershipUserCollection FindUsersByEmail(string emailToMatch, int pageIndex, int pageSize, out int totalRecords)
        {
            ...
            //        try
            //        {
            //            IList<Users> allusers = GetUsersLikeEmail(emailToMatch);
            //            if (allusers == null)
            //                return users;
            //            if (allusers.Count > 0)
            //                totalRecords = allusers.Count;
